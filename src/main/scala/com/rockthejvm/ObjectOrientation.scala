...
object ObjectOrientation extends App:
  ...
  /* constructor arguments are NOT fields: need to put a val before the
   ...
   *
   * class Carnivore_Anonymous_35728 extends Carnivore { override def
   * eat(animal: Animal): Unit = println("I am a dinosaur so I can eat pretty
   * much anything") }
   *
  ...
  /* Benefits:
   * 1) works miracles in multithreaded/distributed env 2) helps making sense of
   * the code ("reasoning about") */
  val reversedList = aList.reverse // returns a NEW list

  // Point #2: Scala is closest to the OO ideal
end ObjectOrientation
